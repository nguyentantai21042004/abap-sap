...
- 📄 **[Phân tích yêu cầu (Requirements)](documentation/requirements/requirements.md)**: Chi tiết các yêu cầu nghiệp vụ và giải pháp kỹ thuật cho từng chức năng.
- 🛠 **[Đề xuất kỹ thuật (Technical Proposal)](documentation/requirements/techical-proposal.md)**: Thiết kế chi tiết về Database, Luồng xử lý (Flowchart), và Kế hoạch triển khai.
- 🌍 **[Tổng quan về SAP (SAP Overview)](documentation/requirements/sap-overview.md)**: Kiến thức nền tảng về ERP, SAP architecture và ngôn ngữ ABAP.
- 📘 **[Hướng dẫn phát triển (Developer Guide)](documentation/guides/developer-guide.md)**: Hướng dẫn cài đặt và phát triển.
- 📝 **[Lịch sử thay đổi (Changelog)](./CHANGELOG.md)**: Theo dõi các cập nhật mới nhất của dự án.

## 📂 Báo cáo & Tài liệu khác

Dự án được tổ chức theo cấu trúc "Source of Truth":

- **Documentation**: `documentation/` (Requirements, Guides, Templates)
- **Reports**: `reports/` (Sắp xếp theo năm/tháng)
  - [Client Report (Jan 2026)](reports/2026/01-jan/client-report.md)
  - [Review Report (Feb 2026)](reports/2026/02-feb/01-review/review-report.md)
