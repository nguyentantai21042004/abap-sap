...
*Mục tiêu tổng thể:* Bàn giao một hệ thống theo dõi lỗi theo vai trò sẵn sàng sản xuất, chạy nguyên bản trên SAP, vượt trội hơn hệ thống tham chiếu (`ZPG_BUGTRACKING_*`) trên tất cả các khía cạnh, trong khung thời gian sprint 10 ngày (24/03 – 03/04/2026) cộng với nâng cao Giai đoạn F (Tháng 4/2026).
...
#table(
  ...
  [*Giai đoạn*], [*Tên*], [*Sản phẩm bàn giao*], [*Trạng thái*],
  ...
  [C], [Giao diện Module Pool (v4.x)], [Chương trình `Z_BUG_WORKSPACE_MP`, 8 màn hình, GUI Status, ALV grids, tab strips], [Hoàn thành],
  [D], [Tính năng nâng cao (v4.x)],   [SmartForms, tải lên/xuống Excel, lớp message, F4 helpers, phát hiện thay đổi chưa lưu], [Hoàn thành],
  [E], [Kiểm thử (v4.x)],         [QC Test Plan (140 ca), UAT (43 ca), kết quả UAT Vòng 1 (11 lỗi tìm thấy)], [Hoàn thành],
  [F], [Nâng cao v5.0],           [Vòng đời 10 trạng thái, Màn hình 0370/0410/0210/0220, tự động phân công v2, tìm kiếm lỗi, dashboard], [CODE xong; triển khai chờ],
)
...
== 3. Sản phẩm Bàn giao Dự án

*Sản phẩm bàn giao nội bộ (tài liệu phát triển):*
...
*Sản phẩm bàn giao bên ngoài (nộp cho Đại học FPT):*
...
Tất cả tài liệu dự án được duy trì qua các giai đoạn phát triển và có header phiên bản ghi ngày cập nhật cuối. Quy ước đánh số phiên bản được sử dụng xuyên suốt dự án:

- `v4.x` --- tài liệu trước Giai đoạn F (bàn giao ban đầu, Giai đoạn A--E)
- `v5.0` --- tài liệu nâng cao Giai đoạn F (phiên bản hiện tại)
