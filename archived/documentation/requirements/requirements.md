...
| Function | Chức năng | Account (Username) | Password |
|----------|-----------|------------|---------|
...
| Permission ID (Account) | T-code / Module Access             | Chức năng trong dự án                | Ánh xạ vào Requirements                                |
| ------------- | ---------------------------------- | ------------------------------------ | ------------------------------------------------------ |
...
1. **Developer Key:**
   - Các account DEV-* đã có developer key chưa?
