...
- **Development Accounts:**
  - Qwer123@ (DEV-118 - Quản lý lỗi)
  - @Anhtuoi123 (DEV-089 - Ghi nhận lỗi)
  - 12345678 (DEV-242 - Email)
  - @57Dt766 (DEV-061 - ALV, SmartForm)
  - toiyeufpt (DEV-237 - Đính kèm file)
...
2. Điền thông tin:
   ...
   - System ID: S40
   - SAProuter String: /H/saprouter.hcc.in.tum.de/S/3298
3. Test connection với account Qwer123@

### Bước 0.3: Verify permissions

**Check các T-code sau:**

- SE11 (ABAP Dictionary) - Permission DEV-089 (Account: @Anhtuoi123)
- SE38 (ABAP Editor) - Permission DEV-089 (Account: @Anhtuoi123)
- SE80 (Object Navigator) - Permission DEV-089 (Account: @Anhtuoi123)
- SCOT (Email config) - Permission DEV-242 (Account: 12345678)
- SMARTFORMS - Permission DEV-061 (Account: @57Dt766)
